# How to Deploy Royal Grandeur Website

This guide will help you deploy your website to Vercel and connect your custom domain (`scd.net.in`).

## 1. Push Code to GitHub

First, ensures your code is safe on GitHub.
1.  Go to [GitHub.com](https://github.com) and create a **New Repository** (name it `royal-grandeur` or similar).
...
git remote add origin https://github.com/YOUR_USERNAME/royal-grandeur.git
git branch -M main
...
3.  You should see your `royal-grandeur` repository. Click **"Import"**.
...
## 3. Connect Your Domain (scd.net.in)

Now, let's make it load on `scd.net.in`.

1.  In your Vercel Project Dashboard, click **"Settings"** (top right tab).
2.  Click **"Domains"** on the left menu.
3.  In the input box, type `scd.net.in` and click **"Add"**.
4.  Vercel will ask how you want to redirect `www`. Recommended: Redirect `www.scd.net.in` to `scd.net.in` (orphans the www).
...
Your site will be live at `https://scd.net.in`!
