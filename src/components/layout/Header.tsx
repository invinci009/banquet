                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center gap-4">
                            <a
                                ...
                                className={`flex items-center gap-2 text-sm font-medium ${isScrolled ? "text-navy-700" : "text-white/90"
                                    }`}
                            >
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    ...
                    >
                        {/* Backdrop */}
                        <div
                            className="absolute inset-0 bg-navy-900/90 backdrop-blur-lg"
                                ...
                                {navLinks.map((link, index) => (
                                    ...
                                    >
                                        <Link
                                            href={link.href}
                                            onClick={() => setIsMobileMenuOpen(false)}
                                            className="block py-3 px-4 text-navy-800 font-medium hover:bg-gold-50 hover:text-gold-700 rounded-lg transition-colors"
                                        >
                                            {link.name}
                                        </Link>
                                    </motion.div>
